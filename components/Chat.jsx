    ...
    <>
      <div className={styles.chat}>
        <div className={styles.flexBetween}>
          <p className={styles.boldText}>Shiba Inu Chat Box</p>
        ...
        <div className={styles.chatContainer}>
          <div className={styles.flexBetween}>
            <div className={styles.flexCenter}>
              <div>
                <Image src={shiba} alt="Shiba" width={70} height={70} />
              </div>
              <div className="mr-10 text-left">
                <b>Masif Ali</b>
                <p className="text-gray-400">@masifalisengupta</p>
              </div>
            </div>
            <div className={styles.flexCenter}>
              <div
      ...
      {/* 
         ...
         */}
      <ChatCard
        content="Coinbase is a amazing stop for all crypto lovers."
        bullish={bullishValue}
        sender={'Masif'}
      />
      <ChatCard content='Bullish or Bearish. Its all upto you' bullish={bullishValue} sender={'Shrenyantak'} />
      <ChatCard content='Its good to be bullish than bearish. What you say ?' bullish={bullishValue} sender={'Dipanwita'} />
    </>
  )
}
