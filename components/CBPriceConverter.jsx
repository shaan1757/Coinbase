...
const styles = {
    coverter: `flex items-center justify-between bg-[#171924] border border-gray-500/10 px-5 py-5 rounded-xl`,
    convertButton: `bg-[#1d4ed8] p-2 px-5 w-min rounded-xl mt-5 cursor-pointer hover:opacity-60`,
}

const CBPriceConverter = ({
  from,
  fromSymbol,
  fromLogo,
  toLogo,
...
export default CBPriceConverter
